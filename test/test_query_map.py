...
class QueryMapTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.kusama_substrate = ReefInterface(url=settings.REEF_NODE_URL)
    ...
    # self.assertEqual(
    # "0x00000a9c44f24e314127af63ae55b864a28d7aee", records[0][0].value
    # )
    # self.assertEqual(
    # "0x00002f21194993a750972574e2d82ce8c95078a6", records[1][0].value
    # )
    # self.assertEqual(
    # "0x0000a940f973ccf435ae9c040c253e1c043c5fb2", records[2][0].value
    # )
    ...
    # if result_count == 1:
    # self.assertEqual(
    # "0x00000a9c44f24e314127af63ae55b864a28d7aee", record[0].value
    # )
    # elif result_count == 2:
    # self.assertEqual(
    # "0x00002f21194993a750972574e2d82ce8c95078a6", record[0].value
    # )
    # elif result_count == 3:
    # self.assertEqual(
    # "0x0000a940f973ccf435ae9c040c253e1c043c5fb2", record[0].value
    # )
    ...
    # self.kusama_substrate.query_map("System", "Account", page_size=9999999)
    ...
    # self.assertEqual(
    # records[0][0].ss58_address,
    # "JCghFN7mD4ETKzMbvSVmMMPwWutJGk6Bm1yKWk8Z9KhPGeZ",
    # )
    # self.assertEqual(
    # records[1][0].ss58_address,
    # "CmNv7yFV13CMM6r9dJYgdi4UTJK7tzFEF17gmK9c3mTc2PG",
    # )
    # self.assertEqual(
    # records[2][0].ss58_address,
    # "DfishveZoxSRNRb8FtyS7ignbw6cr32eCY2w6ctLDRM1NQz",
    # )
    # self.assertEqual(
    # records[3][0].ss58_address,
    # "HmsTAS1bCtZc9FSq9nqJzZCEkhhSygtXj9TDxNgEWTHnpyQ",
    # )
