...
from reefinterface.constants import DEV_PHRASE
from reefinterface.key import extract_derive_path
from reefinterface.exceptions import ConfigurationError
from scalecodec import ScaleBytes
from reefinterface import Keypair, KeypairType
...
class KeyPairTestCase(unittest.TestCase):
    ...
    def test_create_ed25519_keypair(self):
        ...
        self.assertEqual(
            "16dYRUXznyhvWHS1ktUENGfNAEjCawyDzHRtN9AdFnJRc38h", keypair.ss58_address
        )
    ...
    def test_hdkd_nested_numeric_hard_path(self):
        derivation_address = "5E5EPcywWfxL2bJZn2FsZPRTf3djKNsgZxoKVQTbnLmgQhAE"
        derivation_path = "//reef//0"
